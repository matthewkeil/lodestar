...
import {getPubkeysForIndices, waitForNextClosestEpoch} from "../utils.js";
import {ApiError} from "../../errors.js";
import {ValidatorEndpointDependencies} from "./types.js";

export function buildGetAttesterDuties(
  {chain}: ApiModules,
  {notWhileSyncing, maxClockDisparityMs, getGenesisBlockRoot}: ValidatorEndpointDependencies
  ...
  return async function getAttesterDuties(epoch, validatorIndices) {
    ...
    await waitForNextClosestEpoch({clock: chain.clock, maxClockDisparityMs});
